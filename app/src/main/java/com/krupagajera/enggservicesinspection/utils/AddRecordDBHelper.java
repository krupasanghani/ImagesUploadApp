...
public class AddRecordDBHelper extends SQLiteOpenHelper {
    ...
    private static final String TABLE_NAME = "recorddata";
    ...
    public AddRecordDBHelper(Context context) {
    ...
    public void addNewImage(String imageFileName) {
        ...
        values.put(IMAGE_URI, imageFileName);
    ...
    public void updateNotesToImage(String imageUri, String notesImage) {
        ...
        // on below line we are passing all values
        // along with its key and value pair.
        values.put(NOTES_COL, notesImage);

        // on below line we are calling a update method to update our database and passing our values.
        // and we are comparing it with name of our course which is stored in original name variable.
        db.update(TABLE_NAME, values, "ImageURI=?", new String[]{imageUri});
        db.close();
    }

    public void updateAudioToImage(String imageUri, String audioFile) {
        ...
        // on below line we are passing all values
        // along with its key and value pair.
        values.put(AUDIO_URI, audioFile);
    ...
    public void deleteNewImage(String imageRecordID) {
        ...
        db.delete(TABLE_NAME, "ImageURI=?", new String[]{imageRecordID});
        db.close();
    }
